...
l85: # 
	...
	stbinc	r0
		...
		// flags 1, 2
						// (a/p assign)
						// Destination is a variable with offset 101, 0
	...
	stbinc	r0
		...
		// flags 1, 2
						// (a/p assign)
						// Destination is a variable with offset 102, 0
	...
	stbinc	r0
		...
		// flags 1, 2
						// (a/p assign)
						// Destination is a variable with offset 103, 0
		// Real offset of type is 103, isauto 0
						// (prepobj r0)
 						// (prepobj r0)
 						// matchobj comparing flags 82 with 1
						// matchobj comparing flags 82 with 82
